...
resource "aws_wafregional_rule" "owasp_02_auth_token_rule" {
  ...
  predicate {
    data_id = "${aws_wafregional_byte_match_set.owasp_02_auth_token_string_set.id}"
    negated = "false"
    type    = "ByteMatch"
  }
}
...
resource "aws_wafregional_rule" "owasp_03_xss_rule" {
  ...
  predicate {
    data_id = "${aws_wafregional_xss_match_set.owasp_03_xss_set.id}"
    negated = "false"
    type    = "XssMatch"
  }
}
...
resource "aws_wafregional_rule" "owasp_04_paths_rule" {
  ...
  predicate {
    data_id = "${aws_wafregional_byte_match_set.owasp_04_paths_string_set.id}"
    negated = "false"
    type    = "ByteMatch"
  }
}
...
resource "aws_wafregional_rule" "owasp_06_php_insecure_rule" {
  ...
  predicate {
    data_id = "${aws_wafregional_byte_match_set.owasp_06_php_insecure_qs_string_set.id}"
    negated = "false"
    type    = "ByteMatch"
  }

  predicate {
    data_id = "${aws_wafregional_byte_match_set.owasp_06_php_insecure_uri_string_set.id}"
    negated = "false"
    type    = "ByteMatch"
  }
}
...
resource "aws_wafregional_rule" "owasp_08_csrf_rule" {
  ...
  predicate {
    data_id = "${aws_wafregional_byte_match_set.owasp_08_csrf_method_string_set.id}"
    negated = "false"
    type    = "ByteMatch"
  }

  predicate {
    data_id = "${aws_wafregional_size_constraint_set.owasp_08_csrf_token_size_constrain_set.id}"
    negated = "false"
    type    = "SizeConstraint"
  }
}
...
resource "aws_wafregional_rule" "owasp_09_server_side_include_rule" {
  ...
  predicate {
    data_id = "${aws_wafregional_byte_match_set.owasp_09_server_side_include_string_set.id}"
    negated = "false"
    type    = "ByteMatch"
  }
}
...
resource "aws_wafregional_rule_group" "owasp_top_10" {
  ...
  activated_rule {
    ...
    priority = "1"
    rule_id  = "${aws_wafregional_rule.owasp_07_size_restriction_rule.id}"
    type     = "REGULAR"
  }
  ...
  activated_rule {
    ...
    priority = "2"
    rule_id  = "${aws_wafregional_rule.owasp_02_auth_token_rule.id}"
    type     = "REGULAR"
  }
  ...
  activated_rule {
    ...
    priority = "4"
    rule_id  = "${aws_wafregional_rule.owasp_03_xss_rule.id}"
    type     = "REGULAR"
  }
  ...
  activated_rule {
    ...
    priority = "5"
    rule_id  = "${aws_wafregional_rule.owasp_04_paths_rule.id}"
    type     = "REGULAR"
  }
  ...
  activated_rule {
    ...
    priority = "6"
    rule_id  = "${aws_wafregional_rule.owasp_06_php_insecure_rule.id}"
    type     = "REGULAR"
  }
  ...
  activated_rule {
    ...
    priority = "7"
    rule_id  = "${aws_wafregional_rule.owasp_08_csrf_rule.id}"
    type     = "REGULAR"
  }
  ...
  activated_rule {
    ...
    priority = "8"
    rule_id  = "${aws_wafregional_rule.owasp_09_server_side_include_rule.id}"
    type     = "REGULAR"
  }
}
...
resource "aws_waf_rule" "owasp_01_sql_injection_rule" {
  ...
  predicates {
    data_id = "${aws_waf_sql_injection_match_set.owasp_01_sql_injection_set.id}"
    negated = "false"
    type    = "SqlInjectionMatch"
  }
}
